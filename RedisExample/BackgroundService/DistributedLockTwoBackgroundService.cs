...
public class DistributedLockTwoBackgroundService : Microsoft.Extensions.Hosting.BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        {
            Console.WriteLine("order:123 for two background-service");

            // Lock acquired, perform your operations here
            await Task.Delay(10000, stoppingToken); // Simulate some work
        });
    }
    ...
    public async Task CreateLockAsync(string resource, Func<Task> lockFunction)
    {
        ...
        while (true)
        {
            ...
            Console.WriteLine("Lock not acquired, retrying...for two background-service");
